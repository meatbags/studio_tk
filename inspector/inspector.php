	...
	<div class='inspector__mask'>
		<svg viewBox="0 0 1600 800">
          ...
          <?php elseif ($shape == 'shape_2') : ?>
            <polygon fill='#000' transform='translate(400 0)' points="26.6,104.7 773.4,69.4 773.4,696.3 51.3,731.6 "/>
          <?php elseif ($shape == 'shape_3') : ?>
            <path fill='#000' transform='translate(400 0)' d="M262.4,53.1c0,0,63.4,4.5,96.5,0s86-9.1,119.2-9.1s90.5,5.3,90.5,5.3l-42.2,687.1l-264,19.6
            	L262.4,53.1L262.4,53.1z"/>
          <?php elseif ($shape == 'shape_4') : ?>
            <path fill='#000' transform='translate(400 0)' d="M135.5,37.5l505,44c0,0,12,143,12,169s-6,217,0,272s12,228,12,228l-497,12c0,0,3-199,3-240
            	S135.5,37.5,135.5,37.5z"/>
          <?php elseif ($shape == 'shape_5') : ?>
            <path fill='#000' transform='translate(400 0)' d="M142,59.2c0,0,61,12,117,0s98-28,182-31s235,0,235,0l38,745c0,0-201-5-286-12s-268-34-268-34
            	l-22-534.1c0-0.6,0-1.2,0-1.8L142,59.2z"/>
          <?php else : ?>
            <polygon fill='#000' transform='translate(400 0)' points="215.6,89.1 615.3,36 615.3,764 133.7,746.6 "/>
          <?php endif; ?>
				</mask>
			</defs>
