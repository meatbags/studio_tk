				...
				value: function loadIndexItem(id) {
						...
						$.ajax({
								...
								success: function success(data) {
										...
										_this3.addOverlay(data);
										_this3.loadingBar.reset();
								},
...
var LoadingBar = function () {
		...
		_createClass(LoadingBar, [{
				...
				value: function reset() {
						...
						// fallback for lost source, interruptions

						setTimeout(function () {
								if (_this.toLoad != _this.hasLoaded) {
										_this.toLoad = _this.hasLoaded = 0;
										_this.loadingBarUpdate();
								}
						}, 5000);
				}
...
var FabricInspector = function () {
  ...
  _createClass(FabricInspector, [{
    ...
    value: function conformImages() {
      ...
      $('.inspector__image').each(function (i, img) {
        var $e = $(img);
    ...
    value: function resize(image) {
      ...
      var x = -image.naturalWidth * 0.5;
      var y = -image.naturalHeight * 0.25;
    ...
    value: function events() {
      ...
      $('body').on('mousemove', function (e) {
        ...
        if (_this3.active) {
          // set timestamp and try to move inspector

          _this3.moveToMouse(e);

          //this.timestamp = (new Date()).getTime();
          //setTimeout(() => {
          //if ((new Date()).getTime() - this.timestamp > this.timeout) {
          //this.moveToMouse(e);
          //}
          //}, this.timeout + 1);
        }
    ...
    key: 'moveToMouse',
    value: function moveToMouse(e) {
      // move inspector to mouse
      ...
      var x = this.limit.x.clamp(this.mouse.delta.x * this.panAmount + this.offset.x);
      var y = this.limit.y.clamp(this.mouse.delta.y * this.panAmount + this.offset.y);
