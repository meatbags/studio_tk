								...
								value: function initPage() {
												...
												$('.index-trigger').on('click', function (e) {
																...
																if ($e.hasClass('overlay-loaded')) {
																				...
																				_this.loadIndexItem($e.data('post'));
																}
												});
												...
												$(window).on('hashchange', function () {
																if (window.location.hash == '' || _this.lastHash == window.location.hash) {
																				_this.removeOverlay();
																}
												});
								...
								value: function loadIndexItem(id) {
												...
												$.ajax({
																...
																success: function success(data) {
																				...
																				_this2.addOverlay(data);
																				_this2.loadingBar.reset();
																},
    ...
    value: function events() {
      ...
      $('body').on('mousemove', function (e) {
        ...
        if (_this3.active) {
          ...
          var x = _this3.limit.x.clamp(_this3.mouse.delta.x * _this3.panAmount + _this3.offset.x);
          var y = _this3.limit.y.clamp(_this3.mouse.delta.y * _this3.panAmount + _this3.offset.y);
